...
function loadBackendFAGv2(app){

    //docs
    app.get(BASE_API + "/annual-retributions/docs", (req, res) => {
        res.redirect("https://documenter.getpostman.com/view/42233131/2sB2izDCwS");
    });
    ...
    app.post(BASE_API + "/annual-retributions", (req, res) => {
        ...
        newData.subsidized_energy = parseFloat(newData.subsidized_energy);
        newData.total_compensation = parseFloat(newData.total_compensation);
        newData.investment_compensation = parseFloat(newData.investment_compensation);
        newData.operation_compensation = parseFloat(newData.operation_compensation);
        newData.specific_compensation = parseFloat(newData.specific_compensation);
    ...
    app.put(BASE_API + "/annual-retributions" + "/:technology" + "/:year", (req, res) => {
        ...
        data.subsidized_energy = parseFloat(data.subsidized_energy);
        data.total_compensation = parseFloat(data.total_compensation);
        data.investment_compensation = parseFloat(data.investment_compensation);
        data.operation_compensation = parseFloat(data.operation_compensation);
        data.specific_compensation = parseFloat(data.specific_compensation);
